...
public class TwitterElasticQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    public TwitterIndexModel getIndexModelById(String id) {
        ...
        SearchHit<TwitterIndexModel> searchResult = elasticsearchOperations.
        ...
        if(searchResult == null){
            ...
            throw  new ElasticQueryClientException("No document found at elasticsearch wiht id "+ id);
        }
    ...
    public List<TwitterIndexModel> getIndexModelByText(String text) {
        ...
        SearchHits<TwitterIndexModel> searchResult = elasticsearchOperations.
